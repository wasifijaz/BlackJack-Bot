...
static PyCodeObject *codeobj_afd98a59c8bdf356dd4faabf21df5446;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[34]); CHECK_OBJECT(module_filename_obj);
    codeobj_afd98a59c8bdf356dd4faabf21df5446 = MAKE_CODE_OBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[35], mod_consts[35], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_afd98a59c8bdf356dd4faabf21df5446;
    ...
    frame_afd98a59c8bdf356dd4faabf21df5446 = MAKE_MODULE_FRAME(codeobj_afd98a59c8bdf356dd4faabf21df5446, module_cryptography$hazmat$primitives$ciphers);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_afd98a59c8bdf356dd4faabf21df5446);
    assert(Py_REFCNT(frame_afd98a59c8bdf356dd4faabf21df5446) == 2);
    ...
    // Framed code:
    {
        ...
        frame_afd98a59c8bdf356dd4faabf21df5446->m_frame.f_lineno = 1;
        {
    ...
    }
    {
        ...
        frame_afd98a59c8bdf356dd4faabf21df5446->m_frame.f_lineno = 6;
    ...
    tmp_import_from_1__module = NULL;
    {
        ...
        frame_afd98a59c8bdf356dd4faabf21df5446->m_frame.f_lineno = 10;
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_afd98a59c8bdf356dd4faabf21df5446, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_afd98a59c8bdf356dd4faabf21df5446->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_afd98a59c8bdf356dd4faabf21df5446, exception_lineno);
    }



    assertFrameObject(frame_afd98a59c8bdf356dd4faabf21df5446);
